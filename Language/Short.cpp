...
Number_Methode_Add(ShortC, ShortO, "Short", int16_t)
Number_Methode_Sub(ShortC, ShortO, "Short", int16_t)
Number_Methode_Mult(ShortC, ShortO, "Short", int16_t)
Number_Methode_Div(ShortC, ShortO, "Short", int16_t)
Number_Methode_Mod(ShortC, ShortO, "Short", int16_t)
