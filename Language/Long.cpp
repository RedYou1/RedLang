...
Number_Methode_Add(LongC, LongO, "Long")
Number_Methode_Sub(LongC, LongO, "Long")
Number_Methode_Mult(LongC, LongO, "Long")
Number_Methode_Div(LongC, LongO, "Long")
Number_Methode_Mod(LongC, LongO, "Long")
