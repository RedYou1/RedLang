...
Number_Methode_Add(IntegerC, IntegerO, "Integer", int32_t)
Number_Methode_Sub(IntegerC, IntegerO, "Integer", int32_t)
Number_Methode_Mult(IntegerC, IntegerO, "Integer", int32_t)
Number_Methode_Div(IntegerC, IntegerO, "Integer", int32_t)
Number_Methode_Mod(IntegerC, IntegerO, "Integer", int32_t)
