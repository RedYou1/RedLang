...
Array::ArrayC::ArrayC(std::string name, Interface* type)
	:Class(name, "", GLOBAL::getClasses()->getClass(Paths::Object)), m_type(type)
{
...
SourceFile* Array::create(std::string newName, SourceFile** gens, size_t genSize)
{
	if (genSize != 1) {
