...
Number_Methode_Add(ByteC, ByteO, "Byte", int8_t)
Number_Methode_Sub(ByteC, ByteO, "Byte", int8_t)
Number_Methode_Mult(ByteC, ByteO, "Byte", int8_t)
Number_Methode_Div(ByteC, ByteO, "Byte", int8_t)
Number_Methode_Mod(ByteC, ByteO, "Byte", int8_t)
