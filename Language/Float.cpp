...
Number_Methode_Add(FloatC, FloatO, "Float")
Number_Methode_Sub(FloatC, FloatO, "Float")
Number_Methode_Mult(FloatC, FloatO, "Float")
Number_Methode_Div(FloatC, FloatO, "Float")
Number_Methode_fMod(FloatC, FloatO, "Float")
