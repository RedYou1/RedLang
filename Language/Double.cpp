...
Number_Methode_Add(DoubleC, DoubleO, "Double")
Number_Methode_Sub(DoubleC, DoubleO, "Double")
Number_Methode_Mult(DoubleC, DoubleO, "Double")
Number_Methode_Div(DoubleC, DoubleO, "Double")
Number_Methode_fMod(DoubleC, DoubleO, "Double")
