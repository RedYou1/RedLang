...
Number_Methode_LessThan(LongC, LongO, L"Long")
Number_Methode_LessThanEquals(LongC, LongO, L"Long")
Number_Methode_GreaterThan(LongC, LongO, L"Long")
Number_Methode_GreaterThanEquals(LongC, LongO, L"Long")
Number_Methode_Add(LongC, LongO, L"Long", int64_t)
Number_Methode_Sub(LongC, LongO, L"Long", int64_t)
Number_Methode_Mult(LongC, LongO, L"Long", int64_t)
Number_Methode_Div(LongC, LongO, L"Long", int64_t)
Number_Methode_Mod(LongC, LongO, L"Long", int64_t)
