...
Number_Methode_LessThan(ByteC, ByteO, L"Byte")
Number_Methode_LessThanEquals(ByteC, ByteO, L"Byte")
Number_Methode_GreaterThan(ByteC, ByteO, L"Byte")
Number_Methode_GreaterThanEquals(ByteC, ByteO, L"Byte")
Number_Methode_Add(ByteC, ByteO, L"Byte", int8_t)
Number_Methode_Sub(ByteC, ByteO, L"Byte", int8_t)
Number_Methode_Mult(ByteC, ByteO, L"Byte", int8_t)
Number_Methode_Div(ByteC, ByteO, L"Byte", int8_t)
Number_Methode_Mod(ByteC, ByteO, L"Byte", int8_t)
