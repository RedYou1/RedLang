...
Number_Methode_LessThan(DoubleC, DoubleO, L"Double")
Number_Methode_LessThanEquals(DoubleC, DoubleO, L"Double")
Number_Methode_GreaterThan(DoubleC, DoubleO, L"Double")
Number_Methode_GreaterThanEquals(DoubleC, DoubleO, L"Double")
Number_Methode_Add(DoubleC, DoubleO, L"Double", double_t)
Number_Methode_Sub(DoubleC, DoubleO, L"Double", double_t)
Number_Methode_Mult(DoubleC, DoubleO, L"Double", double_t)
Number_Methode_Div(DoubleC, DoubleO, L"Double", double_t)
Number_Methode_fMod(DoubleC, DoubleO, L"Double", double_t)
