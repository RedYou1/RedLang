...
namespace DTO {
	...
	public:
		IllegalArgumentExceptionO(Class* type, std::wstring message)
	...
	public:
		IllegalArgumentExceptionC() : Class(L"IllegalArgumentException", Paths::IllegalArgumentException, GLOBAL::getClasses()->getClass(Paths::Exception)) {
		}
