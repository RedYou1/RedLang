		...
		new Interface* [1]{ GLOBAL::getClasses()->checkGetInterface(std::wstring(Paths::Collection) + L"<" + type->getName() + L">") }, 1), m_type(type)
{
	...
	add(L"add", new Signature(L"", { nullptr, true }, new Arg[3]{ {this,false,L"this"},{ Number,false,L"i"}, {type,true,L"c"} }, 3));
	...
	add(L"indexOf", new Signature(L"", { Number,false }, new Arg[2]{ {this,false,L"this"}, {type,true,L"c" } }, 2));
	add(L"lastIndexOf", new Signature(L"", { Number,false }, new Arg[2]{ {this,false,L"this"},{ type,true,L"c" } }, 2));
	add(L"remove", new Signature(L"", { nullptr,true }, new Arg[2]{ {this,false,L"this"}, {Number,false,L"i"} }, 2));
	add(L"set", new Signature(L"", { nullptr, true }, new Arg[3]{ {this,false,L"this"}, {Number,false,L"i"}, {type,true,L"c" } }, 3));
