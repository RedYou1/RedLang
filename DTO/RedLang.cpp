...
void DTO::RedLang::importRedLang(SourceFile* (*parser)(std::filesystem::path)) {
	...
	object->addFunc(L"toString", String, new Arg[1]{ {object,L"this",nullptr,true} }, 1, new ObjectClass::ToString(String));
	...
	Bool->addFunc(L"Boolean", Bool, new Arg[2]{ {Bool,L"this",nullptr,true}, {Bool,L"c"} }, 2, new BooleanC::BooleanConstruct(Bool));
	Bool->addFunc(L"toString", String, new Arg[1]{ {Bool,L"this",nullptr,true} }, 1, new BooleanC::ToString(String));

	Char->addFunc(L"equals", Bool, new Arg[2]{ {Char,L"this"}, {Char,L"c"} }, 2, new CharC::Equals(Bool));
	Char->addFunc(L"Char", Char, new Arg[2]{ {Char,L"this",nullptr,true}, {Char,L"c"} }, 2, new CharC::CharConstruct(Char));
	Char->addFunc(L"toString", String, new Arg[1]{ {Char,L"this",nullptr,true} }, 1, new CharC::ToString(String));

	String->addFunc(L"equals", Bool, new Arg[2]{ {String,L"this"}, {String,L"c"} }, 2, new StringC::Equals(Bool));
	String->addFunc(L"String", String, new Arg[2]{ {String,L"this",nullptr,true}, {Char,L"c"} }, 2, new StringC::CharConstruct(String));
	String->addFunc(L"String", String, new Arg[2]{ {String,L"this",nullptr,true}, {String,L"c"} }, 2, new StringC::StringConstruct(String));
	String->addFunc(L"concat", String, new Arg[2]{ {String,L"this"}, {object,L"other"} }, 2, new StringC::Concat(String));
	String->addFunc(L"toString", String, new Arg[1]{ {String,L"this",nullptr,true} }, 1, new StringC::ToString(String));
	...
	Byte->addFunc(L"Byte", Byte, new Arg[2]{ {Byte,L"this",nullptr,true}, {Byte,L"c"} }, 2, new ByteC::ByteConstruct(Byte));
	Byte->addFunc(L"toString", String, new Arg[1]{ {Byte,L"this",nullptr,true} }, 1, new ByteC::ToString(String));
	...
	Short->addFunc(L"Short", Short, new Arg[2]{ {Short,L"this",nullptr,true}, {Short,L"c"} }, 2, new ShortC::ShortConstruct(Short));
	Short->addFunc(L"toString", String, new Arg[1]{ {Short,L"this",nullptr,true} }, 1, new ShortC::ToString(String));
	...
	Integer->addFunc(L"Integer", Integer, new Arg[2]{ {Integer,L"this",nullptr,true}, {Integer,L"c"} }, 2, new IntegerC::IntegerConstruct(Integer));
	Integer->addFunc(L"toString", String, new Arg[1]{ {Integer,L"this",nullptr,true} }, 1, new IntegerC::ToString(String));
	...
	Float->addFunc(L"Float", Float, new Arg[2]{ {Float,L"this",nullptr,true}, {Float,L"c"} }, 2, new FloatC::FloatConstruct(Float));
	Float->addFunc(L"toString", String, new Arg[1]{ {Float,L"this",nullptr,true} }, 1, new FloatC::ToString(String));
	...
	Long->addFunc(L"Long", Long, new Arg[2]{ {Long,L"this",nullptr,true}, {Long,L"c"} }, 2, new LongC::LongConstruct(Long));
	Long->addFunc(L"toString", String, new Arg[1]{ {Long,L"this",nullptr,true} }, 1, new LongC::ToString(String));
	...
	Double->addFunc(L"Double", Double, new Arg[2]{ {Double,L"this",nullptr,true}, {Double,L"c"} }, 2, new DoubleC::DoubleConstruct(Double));
	Double->addFunc(L"toString", String, new Arg[1]{ {Double,L"this",nullptr,true} }, 1, new DoubleC::ToString(String));
	...
	classClass->addFunc(L"Class", classClass, new Arg[2]{ {classClass,L"this",nullptr,true}, {file,L"c"} }, 2, new ClassClass::ClassConstruct(classClass, parser));
	...
	classClass->addFunc(L"toString", String, new Arg[1]{ {classClass,L"this",nullptr,true} }, 1, new ClassClass::ToString(String));

	func->addFunc(L"Function", func, new Arg[2]{ {func,L"this",nullptr,true}, {func,L"c"} }, 2, new FunctionClass::FunctionConstruct(func));
	...
	func->addFunc(L"toString", String, new Arg[1]{ {func,L"this",nullptr,true} }, 1, new FunctionClass::ToString(String));

	thread->addFunc(L"Thread", thread, new Arg[2]{ {thread,L"this",nullptr,true}, {func,L"func"} }, 2, new ThreadC::ThreadConstruct(thread), true);
	...
	thread->addFunc(L"toString", String, new Arg[1]{ {thread,L"this",nullptr,true} }, 1, new ThreadC::ToString(String));
	...
	lock->addFunc(L"Lock", lock, new Arg[1]{ {lock,L"this",nullptr,true} }, 1, new LockC::LockConstruct(lock));
	lock->addFunc(L"equals", Bool, new Arg[2]{ {lock,L"this"}, {lock,L"c"} }, 2, new LockC::Equals(Bool));
	lock->addFunc(L"toString", String, new Arg[1]{ {lock,L"this",nullptr,true} }, 1, new LockC::ToString(String));
	...
	file->addFunc(L"File", file, new Arg[2]{ {file,L"this",nullptr,true}, {file,L"c"} }, 2, new FileC::FileCopy(file));
	file->addFunc(L"File", file, new Arg[2]{ {file,L"this",nullptr,true}, {String,L"c"} }, 2, new FileC::FileConstruct(file));
	file->addFunc(L"equals", Bool, new Arg[2]{ {file,L"this"}, {file,L"c"} }, 2, new FileC::Equals(Bool));
	file->addFunc(L"toString", String, new Arg[1]{ {file,L"this",nullptr,true} }, 1, new FileC::ToString(String));
	...
	file->addFunc(L"getFiles", fileArray, new Arg[4]{ {file,L"this"}, {Bool,L"file",new ReturnObj(new BooleanO(Bool,true))},
		{Bool,L"dir",new ReturnObj(new BooleanO(Bool,true))}, {Bool,L"recursive",new ReturnObj(new BooleanO(Bool,false))} }, 4, new FileC::GetFiles(file, fileArray), true);
	...
	except->addFunc(L"Exception", except, new Arg[2]{ {except,L"this",nullptr,true}, {String,L"c"} }, 2, new ExceptionC::ExceptionConstruct(except));
	except->addFunc(L"toString", String, new Arg[1]{ {except,L"this",nullptr,true} }, 1, new ExceptionC::ToString(String));

	castExcept->addFunc(L"CastException", castExcept, new Arg[2]{ {castExcept,L"this",nullptr,true}, {String,L"c"} }, 2, new CastExceptionC::ExceptionConstruct(castExcept));
	nullExcept->addFunc(L"NullException", nullExcept, new Arg[2]{ {nullExcept,L"this",nullptr,true}, {String,L"c"} }, 2, new NullException::ExceptionConstruct(nullExcept));
	argExcept->addFunc(L"IllegalArgumentException", argExcept, new Arg[2]{ {argExcept,L"this",nullptr,true}, {String,L"c"} }, 2, new IllegalArgumentExceptionC::ExceptionConstruct(argExcept));
}