...
namespace DTO {
	...
	public:
		DoubleC(Number* number) : Class(L"Double", Paths::Double, GLOBAL::getClasses()->getClass(Paths::Object), new Interface* [1]{ number }, 1) {
		}
		...
		class DoubleConstruct :public Command {
		public:
			DoubleC* m_s;
			DoubleConstruct(DoubleC* s) :m_s(s) {}
			CommandReturn* exec(MemoryObject& mem) override;
			Command* clone()override { return new DoubleConstruct(m_s); }
		};
		...
		public:
			DoubleC* m_s;
			IllegalArgumentExceptionC* m_except;
			Add(DoubleC* s, IllegalArgumentExceptionC* except) :m_s(s), m_except(except) {}
			CommandReturn* exec(MemoryObject& mem) override;
		...
		public:
			DoubleC* m_s;
			IllegalArgumentExceptionC* m_except;
			Sub(DoubleC* s, IllegalArgumentExceptionC* except) :m_s(s), m_except(except) {}
			CommandReturn* exec(MemoryObject& mem) override;
		...
		public:
			DoubleC* m_s;
			IllegalArgumentExceptionC* m_except;
			Mult(DoubleC* s, IllegalArgumentExceptionC* except) :m_s(s), m_except(except) {}
			CommandReturn* exec(MemoryObject& mem) override;
		...
		public:
			DoubleC* m_s;
			IllegalArgumentExceptionC* m_except;
			Div(DoubleC* s, IllegalArgumentExceptionC* except) :m_s(s), m_except(except) {}
			CommandReturn* exec(MemoryObject& mem) override;
		...
		public:
			DoubleC* m_s;
			IllegalArgumentExceptionC* m_except;
			Mod(DoubleC* s, IllegalArgumentExceptionC* except) :m_s(s), m_except(except) {}
			CommandReturn* exec(MemoryObject& mem) override;
