...
Number_Methode_LessThan(FloatC, FloatO, L"Float")
Number_Methode_LessThanEquals(FloatC, FloatO, L"Float")
Number_Methode_GreaterThan(FloatC, FloatO, L"Float")
Number_Methode_GreaterThanEquals(FloatC, FloatO, L"Float")
Number_Methode_Add(FloatC, FloatO, L"Float", float_t)
Number_Methode_Sub(FloatC, FloatO, L"Float", float_t)
Number_Methode_Mult(FloatC, FloatO, L"Float", float_t)
Number_Methode_Div(FloatC, FloatO, L"Float", float_t)
Number_Methode_fMod(FloatC, FloatO, L"Float", float_t)
