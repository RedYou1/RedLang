...
DTO::CommandReturn* DTO::name::LessThan::exec(MemoryObject& mem) {\
	name2* a{ (name2*)mem.get("this") };\
	NumberO* b{ (NumberO*)mem.get("other") };\
\
...
DTO::CommandReturn* DTO::name::Add::exec(MemoryObject& mem){\
	NumberO* a{ (NumberO*)mem.get("this") };\
	NumberO* b{ (NumberO*)mem.get("other") };\
\
	if(a->isInteger())\
...
DTO::CommandReturn* DTO::name::toName::exec(MemoryObject& mem){return new CommandReturn(mem.get("this"),true,false);}
