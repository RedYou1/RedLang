		...
		new Interface* [1]{ GLOBAL::getClasses()->checkGetInterface(std::wstring(Paths::List) + L"<" + type->getName() + L">") }, 1), m_type(type)
{
	...
	addFunc(L"add", { nullptr, true }, new Arg[2]{ {this,false,L"this"}, {type,true,L"c"} }, 2, new ArrayList::add());
	addFunc(L"add", { nullptr, true }, new Arg[3]{ {this,false,L"this"}, {Number,false,L"i"}, {type,true,L"c"} }, 3, new addI());
	...
	addFunc(L"get", { type,true }, new Arg[2]{ {this,false,L"this"}, {Number,false,L"i"} }, 2, new ArrayList::get());
	addFunc(L"indexOf", { Long,false }, new Arg[2]{ {this,false,L"this"}, {type,true,L"c"} }, 2, new indexOf());
	...
	addFunc(L"remove", { nullptr, true }, new Arg[2]{ {this,false,L"this"}, {type,true,L"c"} }, 2, new remove());
	...
	addFunc(L"set", { nullptr, true }, new Arg[3]{ {this,false,L"this"}, {Number,false,L"i"}, {type,true,L"c" } }, 3, new set());
