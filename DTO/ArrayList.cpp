		...
		new Interface* [1]{ GLOBAL::getClasses()->checkGetInterface(std::wstring(Paths::List) + L"<" + type->getName() + L">") }, 1), m_type(type)
{
	...
	addFunc(L"ArrayList", this, new Arg[1]{ this,L"this" }, 1, new ArrayConstructEmpty(this));
	addFunc(L"ArrayList", this, new Arg[2]{ this,L"this", Number,L"c" }, 2, new ArrayConstructSize(this));
	addFunc(L"ArrayList", this, new Arg[2]{ this,L"this", collection,L"c" }, 2, new ArrayConstructCopy(this));
