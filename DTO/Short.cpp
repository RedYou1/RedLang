...
Number_Methode_LessThan(ShortC, ShortO, L"Short")
Number_Methode_LessThanEquals(ShortC, ShortO, L"Short")
Number_Methode_GreaterThan(ShortC, ShortO, L"Short")
Number_Methode_GreaterThanEquals(ShortC, ShortO, L"Short")
Number_Methode_Add(ShortC, ShortO, L"Short", int16_t)
Number_Methode_Sub(ShortC, ShortO, L"Short", int16_t)
Number_Methode_Mult(ShortC, ShortO, L"Short", int16_t)
Number_Methode_Div(ShortC, ShortO, L"Short", int16_t)
Number_Methode_Mod(ShortC, ShortO, L"Short", int16_t)
