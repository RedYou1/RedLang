...
DTO::GenericFile::GenericFile(std::string name, std::string path, std::string type, std::queue<std::string> genTypes, std::string content)
	:Generic(name, path),
	m_type(type),
...
DTO::SourceFile* DTO::GenericFile::create(std::string newName, SourceFile** gens, size_t genSize)
{
...
DTO::GenericFile* DTO::GenericFile::parse(std::string path, std::string type, std::string name, std::queue<std::string> genTypes, std::string content)
{
